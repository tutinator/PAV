Public Class frm_ABMnadadores
    ...
    Private Function delete() As termino
        ...
        consulta = "DELETE FROM Nadadores WHERE codNad = " & Me.txt_codNadador.Text
        ...
        Catch ex As Exception
            MessageBox.Show("No se puede eliminar este Nadador ya que está siendo referenciado en otra tabla.", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return termino.rechazado
        End Try
    End Function
