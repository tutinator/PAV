Public Class listado_nadadoresInscriptosACompetencia
    Dim acceso As New accesoBD

    Private Sub listado_nadadoresInscriptosATorneo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.cargar_combos()
        Me.rv_inscriptos.RefreshReport()
    End Sub
    ...
    Private Sub consultar()
        ...
        consulta &= "              Clubes.nombre AS nombreClub, Torneos.descripcion AS torneo, Inscripciones.año, Especialidades.descripcion AS espe"
        ...
        consulta &= " AND codEspe = " & Me.cmb_espe.SelectedValue


        tabla = acceso.ejecutar(consulta)

        Me.bs_inscriptos.DataSource = tabla
        Me.rv_inscriptos.RefreshReport()
